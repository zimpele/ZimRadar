...
PIPELINE_STEPS = [
    {
        ...
        "color": "#1565C0",
        "what": "Counties across 5 US states (CA, CO, FL, IA, NC) are photographed from space every 5 days by the European Space Agency's Sentinel-2 satellites.",
        "how": [
    ...
    },
    {
        ...
        "color": "#E65100",
        "what": "A machine learning model trained on historical disaster patterns combines all 14 risk factors and assigns each county a climate risk tier.",
        "how": [
            "14 features: flood history, vegetation loss, urban density, elevation, infrastructure age, storm events + more",
            "Trained on real FEMA disaster data with class-balanced weights",
            "SHAP values explain *why* each county got its score",
        ],
        "tech": "XGBoost · SHAP explainability · AUC 0.9182",
    },
    {
        "emoji": "🗺️",
        "title": "Interactive Risk Map",
        "color": "#880E4F",
        "what": "Every county appears on a live map with its risk score gradient, a SHAP waterfall chart, and an AI risk briefing generated by a LangGraph agent running entirely on-server.",
        "how": [
